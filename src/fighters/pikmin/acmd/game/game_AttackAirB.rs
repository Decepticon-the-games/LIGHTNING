...
#[acmd_script( agent = "pikmin_pikmin", script = "game_attackairb_b", category = ACMD_GAME, low_priority )]
unsafe fn game_attackairb_b(fighter: &mut L2CAgentBase) {
    let entry_id = WorkModule::get_int(fighter.module_accessor, *FIGHTER_INSTANCE_WORK_ID_INT_ENTRY_ID) as usize;
    frame(fighter.lua_state_agent, 9.0);
    if macros::is_excute(fighter) {
        PIKMIN_PIKMIN_ATTACK_CANCEL[entry_id] = true; 
...
#[acmd_script( agent = "pikmin_pikmin", script = "game_attackairb_v", category = ACMD_GAME, low_priority )]
unsafe fn game_attackairb_v(fighter: &mut L2CAgentBase) {
    let entry_id = WorkModule::get_int(fighter.module_accessor, *FIGHTER_INSTANCE_WORK_ID_INT_ENTRY_ID) as usize;
    frame(fighter.lua_state_agent, 9.0);
    if macros::is_excute(fighter) {
        PIKMIN_PIKMIN_ATTACK_CANCEL[entry_id] = true; 
...
#[acmd_script( agent = "pikmin_pikmin", script = "game_attackairb_w", category = ACMD_GAME, low_priority )]
unsafe fn game_attackairb_w(fighter: &mut L2CAgentBase) {
    let entry_id = WorkModule::get_int(fighter.module_accessor, *FIGHTER_INSTANCE_WORK_ID_INT_ENTRY_ID) as usize;
    frame(fighter.lua_state_agent, 9.0);
    if macros::is_excute(fighter) {
        PIKMIN_PIKMIN_ATTACK_CANCEL[entry_id] = true; 
...
#[acmd_script( agent = "pikmin_pikmin", script = "game_attackairb_y", category = ACMD_GAME, low_priority )]
unsafe fn game_attackairb_y(fighter: &mut L2CAgentBase) {
    let entry_id = WorkModule::get_int(fighter.module_accessor, *FIGHTER_INSTANCE_WORK_ID_INT_ENTRY_ID) as usize;
    frame(fighter.lua_state_agent, 9.0);
    if macros::is_excute(fighter) {
        PIKMIN_PIKMIN_ATTACK_CANCEL[entry_id] = true; 
