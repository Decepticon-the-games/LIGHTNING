use super::*;
#[acmd_script( agent = "nana", script = "game_specialscommoncouplesub", category = ACMD_GAME, low_priority )]
unsafe fn game_specialscommoncouplesub(fighter: &mut L2CAgentBase) {
