use super::*;
#[acmd_script( agent = "littlemac", script = "game_specialairnmaxdashturn", category = ACMD_GAME, low_priority )]
unsafe fn game_specialairnmaxdashturn(fighter: &mut L2CAgentBase) {
