use super::*;
#[acmd_script( agent = "wario", script = "game_specialairlwflyr", category = ACMD_GAME, low_priority )]
unsafe fn game_specialairlwflyr(fighter: &mut L2CAgentBase) {
