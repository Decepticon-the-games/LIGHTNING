...
pub fn once_per_fighter_frame(fighter : &mut L2CFighterCommon) {
    ...
    //
        ...
        && ! (status_kind == *FIGHTER_DEMON_STATUS_KIND_ATTACK_STEP_2F && frame <15.0 )
        && ! (status_kind == *FIGHTER_DEMON_STATUS_KIND_ATTACK_STEP_2L && frame <27.0 )
        && ! (status_kind == *FIGHTER_DEMON_STATUS_KIND_ATTACK_STEP_2S && frame <33.0 )
