use super::*;
#[acmd_script( agent = "jack", script = "game_specialnescapef_ex", category = ACMD_GAME, low_priority )]
unsafe fn game_specialnescapef_ex(fighter: &mut L2CAgentBase) {
