...
//Enable cancel  
            ...
            if (status_kind == *FIGHTER_MIISWORDSMAN_STATUS_KIND_SPECIAL_N3_END) {
                if frame >14.0 {
            ...
            else if (status_kind == *FIGHTER_MIISWORDSMAN_STATUS_KIND_SPECIAL_N3_END_MAX) {
                if frame >32.0 {
                    ENABLE_ATTACK_CANCEL[entry_id] = true;
                }
                else {
            ...
            else if status_kind == *FIGHTER_MIISWORDSMAN_STATUS_KIND_SPECIAL_N3_END
...
pub fn install() {
    smashline::install_agent_frames!(miiswordsman_opff);
