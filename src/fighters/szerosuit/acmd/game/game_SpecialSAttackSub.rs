use super::*;
#[acmd_script( agent = "szerosuit", script = "game_specialsattacksub", category = ACMD_GAME, low_priority )]
unsafe fn game_specialsattacksub(fighter: &mut L2CAgentBase) {
