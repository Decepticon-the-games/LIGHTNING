use super::*;
#[acmd_script( agent = "snake", script = "game_speciallwsquatground", category = ACMD_GAME, low_priority )]
unsafe fn game_speciallwsquatground(fighter: &mut L2CAgentBase) {
