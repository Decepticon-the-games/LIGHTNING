use super::*;
#[acmd_script( agent = "jack", script = "game_specialairlwcounter", category = ACMD_GAME, low_priority )]
unsafe fn game_specialairlwcounter(fighter: &mut L2CAgentBase) {
