use super::*;
#[acmd_script( agent = "nana", script = "game_specialsattacksinglebsub", category = ACMD_GAME, low_priority )]
unsafe fn game_specialsattacksinglebsub(fighter: &mut L2CAgentBase) {
