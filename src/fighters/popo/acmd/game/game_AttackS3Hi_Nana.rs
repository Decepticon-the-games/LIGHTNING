use super::*;
#[acmd_script( agent = "popo", script = "game_attacks3hi_nana", category = ACMD_GAME, low_priority )]
unsafe fn game_attacks3hi_nana(fighter: &mut L2CAgentBase) {
