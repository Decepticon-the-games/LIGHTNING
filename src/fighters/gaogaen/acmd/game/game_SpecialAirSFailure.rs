use super::*;
#[acmd_script( agent = "gaogaen", script = "game_specialairsfailure", category = ACMD_GAME, low_priority )]
unsafe fn game_specialairsfailure(fighter: &mut L2CAgentBase) {
