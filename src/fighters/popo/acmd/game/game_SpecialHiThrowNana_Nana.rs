use super::*;
#[acmd_script( agent = "popo", script = "game_specialhithrownana_nana", category = ACMD_GAME, low_priority )]
unsafe fn game_specialhithrownana_nana(fighter: &mut L2CAgentBase) {
