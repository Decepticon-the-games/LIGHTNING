use super::*;
#[acmd_script( agent = "snake", script = "game_specialnthrowhi", category = ACMD_GAME, low_priority )]
unsafe fn game_specialnthrowhi(fighter: &mut L2CAgentBase) {
