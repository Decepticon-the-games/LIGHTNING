use super::*;
#[acmd_script( agent = "nana", script = "game_specialsattackbsub_nana", category = ACMD_GAME, low_priority )]
unsafe fn game_specialsattackbsub_nana(fighter: &mut L2CAgentBase) {
