use super::*;
#[acmd_script( agent = "tantan", script = "game_attack_blocked_punch_l", category = ACMD_GAME, low_priority )]
unsafe fn game_attack_blocked_punch_l(fighter: &mut L2CAgentBase) {
