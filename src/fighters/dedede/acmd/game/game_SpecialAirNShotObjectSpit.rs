use super::*;
#[acmd_script( agent = "dedede", script = "game_specialairnshotobjectspit", category = ACMD_GAME, low_priority )]
unsafe fn game_specialairnshotobjectspit(fighter: &mut L2CAgentBase) {
