...
#[acmd_script( agent = "donkey", script = "game_throwb", category = ACMD_GAME, low_priority )]
...
#[acmd_script( agent = "donkey", script = "game_throwlw", category = ACMD_GAME, low_priority )]
