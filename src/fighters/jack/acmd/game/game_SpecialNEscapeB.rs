use super::*;
#[acmd_script( agent = "jack", script = "game_specialnescapeb", category = ACMD_GAME, low_priority )]
unsafe fn game_specialnescapeb(fighter: &mut L2CAgentBase) {
