use super::*;
#[acmd_script( agent = "miifighter", script = "game_specialairn2finish", category = ACMD_GAME, low_priority )]
unsafe fn game_specialairn2finish(fighter: &mut L2CAgentBase) {
