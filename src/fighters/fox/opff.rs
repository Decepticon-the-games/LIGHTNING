...
//Shime cancel jump   
            if motion_kind == smash::hash40("special_lw_loop")
            || motion_kind == smash::hash40("special_lw_loop_l")
            || motion_kind == smash::hash40("special_lw_hit")
            || motion_kind == smash::hash40("special_lw_hit_l") 
            || motion_kind == smash::hash40("special_air_lw_loop")
            || motion_kind == smash::hash40("special_air_lw_loop_l")
            || motion_kind == smash::hash40("special_air_lw_hit")
            || motion_kind == smash::hash40("special_air_lw_hit_l") {
                if frame >= 1.0 {
