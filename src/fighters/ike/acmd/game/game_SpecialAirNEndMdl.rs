use super::*;
#[acmd_script( agent = "ike", script = "game_specialairnendmdl", category = ACMD_GAME, low_priority )]
unsafe fn game_specialairnendmdl(fighter: &mut L2CAgentBase) {
