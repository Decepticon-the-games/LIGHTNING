use super::*;
#[acmd_script( agent = "jack", script = "game_specialairnescapef", category = ACMD_GAME, low_priority )]
unsafe fn game_specialairnescapef(fighter: &mut L2CAgentBase) {
