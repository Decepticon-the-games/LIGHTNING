use super::*;
#[acmd_script( agent = "packun", script = "game_specialairnshootb", category = ACMD_GAME, low_priority )]
unsafe fn game_specialairnshootb(fighter: &mut L2CAgentBase) {
