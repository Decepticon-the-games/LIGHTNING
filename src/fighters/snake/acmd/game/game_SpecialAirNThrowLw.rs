use super::*;
#[acmd_script( agent = "snake", script = "game_specialairnthrowlw", category = ACMD_GAME, low_priority )]
unsafe fn game_specialairnthrowlw(fighter: &mut L2CAgentBase) {
