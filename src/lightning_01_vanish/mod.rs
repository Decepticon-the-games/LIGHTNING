...
//mod ryu;
//use crate::ryu::{VANISH, OPPONENT_X, OPPONENT_Y, OPPONENT_BOMA, CAMERA}; // Imports some of Ryu's variables into lib.rs
...
move_type_again: bool) -> u64 {
    ...
    if utility::get_category(&mut *attacker_boma) == *BATTLE_OBJECT_CATEGORY_FIGHTER { // if you're the attacker
        if SEC_SEN_STATE[a_entry_id] {
            ...
            || utility::get_category(&mut *defender_boma) == *BATTLE_OBJECT_CATEGORY_ENEMY { // if the one being attacked (defender) is a fighter/enemy
            ...
            else if utility::get_category(&mut *defender_boma) == *BATTLE_OBJECT_CATEGORY_WEAPON {
                ...
                if utility::get_category(&mut *oboma) != *BATTLE_OBJECT_CATEGORY_FIGHTER {
                    ...
                    OPPONENT_BOMA[a_entry_id] = (&mut *oboma as *mut BattleObjectModuleAccessor) as u64;
                    if utility::get_category(&mut *oboma) == *BATTLE_OBJECT_CATEGORY_FIGHTER {
...
pub fn once_per_fighter_frame(fighter : &mut L2CFighterCommon) {
    unsafe {
        ...
        if entry_id < 8 {
            ...
            else if AttackModule::is_attack_occur(fighter.module_accessor) && ! SlowModule::is_slow(fighter.module_accessor) {
            ...
            else if VANISH[entry_id] == false // Turns off all of the effects of Secret Sensation.
