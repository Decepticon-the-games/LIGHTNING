use super::*;
#[acmd_script( agent = "inkling", script = "game_specialairlwmiddle", category = ACMD_GAME, low_priority )]
unsafe fn game_specialairlwmiddle(fighter: &mut L2CAgentBase) {
