use super::*;
#[acmd_script( agent = "jack", script = "game_speciallwreflector", category = ACMD_GAME, low_priority )]
unsafe fn game_speciallwreflector(fighter: &mut L2CAgentBase) {
