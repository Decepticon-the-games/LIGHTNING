use super::*;
#[acmd_script( agent = "dedede", script = "game_specialairnspit", category = ACMD_GAME, low_priority )]
unsafe fn game_specialairnspit(fighter: &mut L2CAgentBase) {
