use super::*;
#[acmd_script( agent = "nana", script = "game_specialsattackbsub", category = ACMD_GAME, low_priority )]
unsafe fn game_specialsattackbsub(fighter: &mut L2CAgentBase) {
