use super::*;
#[acmd_script( agent = "jack", script = "game_specialairnescapef_ex", category = ACMD_GAME, low_priority )]
unsafe fn game_specialairnescapef_ex(fighter: &mut L2CAgentBase) {
