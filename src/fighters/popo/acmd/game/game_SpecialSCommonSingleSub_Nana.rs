use super::*;
#[acmd_script( agent = "popo", script = "game_specialscommonsinglesub_nana", category = ACMD_GAME, low_priority )]
unsafe fn game_specialscommonsinglesub_nana(fighter: &mut L2CAgentBase) {
...
pub fn install() {
    smashline::install_acmd_scripts!(
     game_specialscommonsinglesub_nana);
}