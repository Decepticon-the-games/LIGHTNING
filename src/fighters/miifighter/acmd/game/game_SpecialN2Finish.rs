use super::*;
#[acmd_script( agent = "miifighter", script = "game_specialn2finish", category = ACMD_GAME, low_priority )]
unsafe fn game_specialn2finish(fighter: &mut L2CAgentBase) {
