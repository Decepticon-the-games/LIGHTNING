use super::*;
#[acmd_script( agent = "snake", script = "game_specialairlwwall", category = ACMD_GAME, low_priority )]
unsafe fn game_specialairlwwall(fighter: &mut L2CAgentBase) {
