...
use crate::fighters::{
 ...
 mod game_SpecialSDischarge; 
 mod game_SpecialAirSEnd;
 mod game_SpecialHi;
 mod game_SpecialHi2Sub; 
...
game_AirCatchLanding::install();
game_AppealLwL::install();  
game_AppealLwR::install();  
...
game_SpecialSDischarge::install();  
game_SpecialAirSEnd::install(); 
game_SpecialHi::install(); 
game_SpecialHi2Sub::install();  
