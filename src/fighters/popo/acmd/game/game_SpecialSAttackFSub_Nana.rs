use super::*;
#[acmd_script( agent = "popo", script = "game_specialsattackfsub_nana", category = ACMD_GAME, low_priority )]
unsafe fn game_specialsattackfsub_nana(fighter: &mut L2CAgentBase) {
