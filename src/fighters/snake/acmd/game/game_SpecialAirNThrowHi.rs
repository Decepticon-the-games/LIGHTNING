use super::*;
#[acmd_script( agent = "snake", script = "game_specialairnthrowhi", category = ACMD_GAME, low_priority )]
unsafe fn game_specialairnthrowhi(fighter: &mut L2CAgentBase) {
