use super::*;
#[acmd_script( agent = "nana", script = "game_specialsattackfsub", category = ACMD_GAME, low_priority )]
unsafe fn game_specialsattackfsub(fighter: &mut L2CAgentBase) {
