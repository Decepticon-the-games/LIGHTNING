use super::*;
#[acmd_script( agent = "nana", script = "game_specialsattacksinglebsub_nana", category = ACMD_GAME, low_priority )]
unsafe fn game_specialsattacksinglebsub_nana(fighter: &mut L2CAgentBase) {
...
pub fn install() {
    smashline::install_acmd_scripts!(
     game_specialsattacksinglebsub_nana);
}